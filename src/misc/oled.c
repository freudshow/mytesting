...
void OLED_GUI_DrawPoint(oledGuiPoint_s *pPoint)
{
    u8 row, m, n;
    ...
    {
    	s_OLED_GRAM[row][pPoint->x] |= n;
    }
    else   //如果是熄灭，则将这一像素对应的位, 置0
    {
    	s_OLED_GRAM[row][pPoint->x] &= (~(1 << m));
    }
}

void OLED_clearRectangle(u8 top, u8 bottom, u8 left, u8 right)
{
